...
import com.mcgrady.xpay.interf.AuthResultCallBack;
    ...
    public void auth() {
        if (paramsModel == null) {
            ...
            if (TextUtils.isEmpty(paramsModel.pId)
                ...
                Log.e("AliAuthReq", "错误: 需要配置PARTNER |APP_ID| RSA_PRIVATE| TARGET_ID");

                if (authResultCallBack != null) {
                    authResultCallBack.onAuthFailure("错误: 需要配置PARTNER |APP_ID| RSA_PRIVATE| TARGET_ID");
                }
                return;
            }
